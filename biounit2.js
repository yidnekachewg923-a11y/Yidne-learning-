...
<input type="radio" name="q16" onclick="checkQ16('A')">
A. Producing food<br>

<input type="radio" name="q16" onclick="checkQ16('B')">
B. Identifying unfamiliar organisms<br>

<input type="radio" name="q16" onclick="checkQ16('C')">
C. Making energy<br>

<input type="radio" name="q16" onclick="checkQ16('D')">
...
<input type="radio" name="q17" onclick="checkQ17('A')">
A. Warm-blooded<br>

<input type="radio" name="q17" onclick="checkQ17('B')">
B. Cold-blooded<br>

<input type="radio" name="q17" onclick="checkQ17('C')">
C. Single-celled<br>

<input type="radio" name="q17" onclick="checkQ17('D')">
D. Multicellular<br>
...
<input type="radio" name="q18" onclick="checkQ18('A')">
A. Cold-blooded<br>

<input type="radio" name="q18" onclick="checkQ18('B')">
B. Warm-blooded<br>

<input type="radio" name="q18" onclick="checkQ18('C')">
C. Without a nucleus<br>

<input type="radio" name="q18" onclick="checkQ18('D')">
...
<input type="radio" name="q19" onclick="checkQ19('A')">
A. Species<br>

<input type="radio" name="q19" onclick="checkQ19('B')">
B. Genus<br>

<input type="radio" name="q19" onclick="checkQ19('C')">
C. Kingdom<br>

<input type="radio" name="q19" onclick="checkQ19('D')">
D. Family<br>
...
<input type="radio" name="q20" onclick="checkQ20('A')">
A. Cocci<br>

<input type="radio" name="q20" onclick="checkQ20('B')">
B. Bacilli<br>

<input type="radio" name="q20" onclick="checkQ20('C')">
C. Monera<br>

<input type="radio" name="q20" onclick="checkQ20('D')">
D. Spirillum<br>
...
<input type="radio" name="q21" onclick="checkQ21('A')">
A. Plants and animals<br>

<input type="radio" name="q21" onclick="checkQ21('B')">
B. Eubacteria and archaebacteria<br>

<input type="radio" name="q21" onclick="checkQ21('C')">
C. Fungi and plants<br>

<input type="radio" name="q21" onclick="checkQ21('D')">
D. Only animals<br>
...
<input type="radio" name="q22" onclick="checkQ22('A')">
A. Bacilli<br>

<input type="radio" name="q22" onclick="checkQ22('B')">
B. Spirillum<br>

<input type="radio" name="q22" onclick="checkQ22('C')">
C. Cocci<br>

<input type="radio" name="q22" onclick="checkQ22('D')">
D. Archaea<br>
...
<input type="radio" name="q23" onclick="checkQ23('A')">
A. Cocci<br>

<input type="radio" name="q23" onclick="checkQ23('B')">
B. Bacilli<br>

<input type="radio" name="q23" onclick="checkQ23('C')">
C. Spirillum<br>

<input type="radio" name="q23" onclick="checkQ23('D')">
D. Archaea<br>
...
<input type="radio" name="q24" onclick="checkQ24('A')">
A. Cocci<br>

<input type="radio" name="q24" onclick="checkQ24('B')">
B. Bacilli<br>

<input type="radio" name="q24" onclick="checkQ24('C')">
C. Spirillum<br>

<input type="radio" name="q24" onclick="checkQ24('D')">
D. Eubacteria<br>
...
<input type="radio" name="q25" onclick="checkQ25('A')">
A. Only in plants<br>

<input type="radio" name="q25" onclick="checkQ25('B')">
B. In extreme environments<br>

<input type="radio" name="q25" onclick="checkQ25('C')">
C. Only in human blood<br>

<input type="radio" name="q25" onclick="checkQ25('D')">
